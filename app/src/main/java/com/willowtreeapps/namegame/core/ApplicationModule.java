...
class ApplicationModule {
    ...
    @Provides @NonNull @Singleton
    public NameGameManager providerNameGameManager(@NonNull ProfilesRepository repo,
                                                   @NonNull ListRandomizer randomizer){
        return new NameGameManager(repo,randomizer);
    }
